@include('templates.catalog.filter.view-categories')

<!DOCTYPE html>
<html>
<head>
  <title>VER UM TITULO DEPOIS</title>
  <meta charset="UTF-8">
  ...
  .test-tag-a[data-ola-mundo='teste do att data-'] {
    color: red;
...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  {{-- Trás do banco as categorias aqui --}}
    @yield('cont-cat')
